# ══ ВХІД / РЕЖИМИ ════════════════════════════════════════
# Підпис під банером (до 1024 символів)
WELCOME_BANNER_CAPTION = (
    ...
    "повноцінного бот-помічника замість дзвінків і переписок.\n\n"
    "📱 <b>У цьому боті ви зможете:</b>\n"
    "💅 Записатись на манікюр чи педикюр за хвилину\n"
    "🤖 Отримати ІІ-консультацію по догляду\n"
    "🎁 Знайти слоти зі знижкою\n"
    "📞 Замовити дзвінок майстра\n"
    "⏰ Отримувати нагадування — більше не забудете про візит\n\n"
    "Усе в одному місці, без зайвих дзвінків і очікувань. 💜\n\n"
    "<b>Як бажаєте увійти?</b>"
)

# Текстова версія (без банера) — для переходів «На початок»
ROLE_SELECT = (
    "✨ <b>Beauty &amp; Shine</b>\n\n"
    "Студія краси та здоров'я в Ізмаїлі.\n\n"
    "Оберіть, як увійти:"
)
...
PEDICURE_INTRO = (
    "🦶 <b>Педикюр</b>\n\n"
    "Майстер Іван індивідуально скорегує тривалість під вашу ситуацію.\n\n"
